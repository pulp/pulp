...
from rpm_upload.category import CreatePackageCategoryCommand
from rpm_upload.errata import CreateErratumCommand
from rpm_upload.group import CreatePackageGroupCommand
...
def initialize(context):
    ...
    uploads_section.add_command(CreatePackageGroupCommand(context, upload_manager))
    uploads_section.add_command(CreatePackageCategoryCommand(context, upload_manager))

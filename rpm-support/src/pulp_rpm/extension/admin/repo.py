...
# IDs the repo will use to refer to the automatically added yum and iso distributor
...
class RpmRepoCreateCommand(PulpCliCommand):

    def __init__(self, context):
        desc = 'creates a new repository that is configured to sync and publish RPM related content'
        super(RpmRepoCreateCommand, self).__init__('create', desc, self.create)
...
class RpmRepoUpdateCommand(PulpCliCommand):
    def __init__(self, context):
        desc = 'updates an existing repository\'s configuration'
        super(RpmRepoUpdateCommand, self).__init__(self, 'update', desc, self.update)
    ...
    def update(self, **kwargs):
        ...
        distributor_configs = {YUM_DISTRIBUTOR_ID : distributor_config}
...
class RpmRepoListCommand(PulpCliCommand):

    def __init__(self, context):
        super(RpmRepoListCommand, self).__init__(self, 'list', 'lists repositories on the server', self.list)
        self.context = context

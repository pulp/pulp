...
class RepoSyncScheduleStrategyTests(rpm_support_base.PulpClientTests):

    def setUp(self):
        super(RepoSyncScheduleStrategyTests, self).setUp()
    ...
    def test_create_schedule(self, mock_add):
        ...
        self.assertEqual(YUM_IMPORTER_ID, call_args[1])

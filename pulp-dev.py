...
LINKS = (
    ...
    ('src/pulp/client/consumer/gofer/pulpplugin.py', '/usr/lib/gofer/plugins/pulpplugin.py'),
    ('src/pulp/client/consumer/gofer/consumer.py', '/usr/lib/gofer/plugins/consumer.py'),

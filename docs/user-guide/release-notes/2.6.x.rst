...
This is a minor release which contains bug fixes for :fixedbugs_pulp:`these issues <2.6.5>`.

Pulp 2.6.4
==========

Pulp 2.6.4 is an important security update. It fixes
:fixedbugs_pulp:`one issue <2.6.4>`.
...
This is a minor release which contains bug fixes for :fixedbugs_pulp:`these issues <2.6.3>`.
...
This is a minor release which contains bug fixes for :fixedbugs_pulp:`these issues <2.6.2>`.
...
This is a minor release which contains bug fixes for :fixedbugs_pulp:`these issues <2.6.1>`.
...
This release has fixes for :fixedbugs_pulp:`these issues <2.6.0>`.

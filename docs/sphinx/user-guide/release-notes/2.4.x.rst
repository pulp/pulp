...
The
`Scheduled Call data structure <https://pulp-dev-guide.readthedocs.org/en/latest/conventions/scheduled.html#scheduled-tasks>`_
...
``/v2/queued_calls/``
    ...
    This API has been removed in 2.4, as no distinction is made between queued tasks and running
    tasks in Pulp 2.4.

...
Pulp 2.4.0 has an added functionality to validate the server SSL cert against trusted CA certs.
...
:ref:`Installation Guide <admin_trusted_ca_installtion>`. For consumers, you can refer to

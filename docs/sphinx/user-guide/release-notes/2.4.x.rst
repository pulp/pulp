...
.. note::
   If you are using Qpid 0.18 or earlier, you also need to install the qpid-cpp-server-store package
   using the command: ``sudo yum install qpid-cpp-server-store``

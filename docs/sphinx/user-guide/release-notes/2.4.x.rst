...
to generate private key and SSL certificate signed by Pulp CA certificate. If you want to
regenerate your Pulp CA certificate, you can do so by running ``pulp-gen-ca-certificate``
before generating SSL certificate. You can also opt to not use these script and generate
...
If you end up replacing or generating new CA certificate above, you will need to copy and
...
:ref:`Installation Guide <admin_trusted_ca_installtion>`. For consumers, you can
refer to :ref:`Installation Guide <consumer_trusted_ca_installtion>`.

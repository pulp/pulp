...
from pulp.server.webservices.views.content import (
    ...
    ContentTypesView, ContentUnitResourceView, ContentUnitSearch, ContentUnitsCollectionView,
...
urlpatterns = patterns('',
    ...
    url(r'^v2/repositories/search/$', RepoSearch.as_view(), name='repo_search_view'),

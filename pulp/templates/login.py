...
# Kid template module
kid_version = '0.9.6'
kid_file = '/home/mmccune/devel/trunk/playpen/turbogears/pulp/pulp/templates/login.kid'
import kid
...
class Template(BaseTemplate1, BaseTemplate):
	...
	def _pull(self):
		...
		yield START, current
		yield TEXT, u'\n'
		_cont = login_form.display(submit_text='Login')
		ancestors.insert(0, current)
		...
		yield START, current
		yield TEXT, u'Some Text Please Translate Me'
		yield END, current
		current = ancestors.pop(0)
		yield TEXT, u'\n\n'
		ancestors.insert(0, current)

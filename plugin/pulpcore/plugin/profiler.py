class Profiler(object):
    ...
    :class: `~pulpcore.plugin.ContentUnit` objects. Those objects are in the repo and are applicable
    ...
    :ivar repo: The repository to be used to calculate applicability against the given
                consumer profile.
    :type repo: :class: `pulpcore.plugin.Repository`
    """

    def __init__(self, repo):
        """
        Initialize with a :class: `pulpcore.plugin.Repository` object
    ...
    def calculate_applicable_units(self, unit_profile):
        ...
        Calculate and return a list of subclasses of :class: `~pulpcore.plugin.ContentUnit`
        ...
        :return: a list of applicable :class: `~pulpcore.plugin.ContentUnit` objects
        :rtype: list of :class: `~pulpcore.plugin.ContentUnit` objects
        """

...
CALL_COMPLETED_STATE = 'completed'
CALL_ERRORED_STATE = 'errored'
...
CALL_COMPLETE_STATES = (CALL_SKIPPED_STATE, CALL_COMPLETED_STATE, CALL_ERRORED_STATE,
                        CALL_CANCELED_STATE)
CALL_STATES = (CALL_WAITING_STATE, CALL_SKIPPED_STATE, CALL_ACCEPTED_STATE, CALL_RUNNING_STATE,
               CALL_SUSPENDED_STATE, CALL_COMPLETED_STATE, CALL_ERRORED_STATE, CALL_CANCELED_STATE)

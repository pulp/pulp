...
curl -H "Accept: application/json" -H "WebFrameworkSwitch: django" -X POST -d '{"hello": "world"}' -k -u admin:admin -o /tmp/django.body "https://localhost/pulp/api$1"
curl -H "Accept: application/json" -H "WebFrameworkSwitch: webpy" -X POST -d '{"hello": "world"}' -k -u admin:admin -o /tmp/webpy.body "https://localhost/pulp/api$1"

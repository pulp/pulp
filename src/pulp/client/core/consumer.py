...
class History(ConsumerAction):
    ...
    def setup_parser(self):
        ...
        self.parser.add_option('--start_date', dest='start_date',
                               help=_('only return entries that occur after the given date (format: yyyy-mm-dd)'))
        self.parser.add_option('--end_date', dest='end_date',
                               help=_('only return entries that occur before the given date (format: yyyy-mm-dd)'))

...
"""
Module containing classes to manage consumer credentials.
"""
...
class ConsumerBundle(Bundle):
    ...
    def path(cls):
        ...
        First looks in configuration [filesystem].consumer_cert
        @return: File path.
        @rtype: str
        """
        cfg = ConsumerConfig()
        path = cfg.filesystem.consumer_cert

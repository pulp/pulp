...
class EventFireManager(object):
    ...
    def fire_repo_sync_started(self, repo_id):
        ...
        self._do_fire(event_data.Event(event_data.TYPE_REPO_SYNC_STARTED, payload))

    def fire_repo_sync_finished(self, sync_result):
        """
        Fires an event indicating the given repository has compelted a sync.
        ...
        """
        self._do_fire(event_data.Event(event_data.TYPE_REPO_SYNC_FINISHED, sync_result))

...
class ConsumerScheduleManager(object):
    ...
    def _create_schedule(self, itinerary_method, consumer_id, units, options, schedule_data):
        ...
        call_request = CallRequest(itinerary_method, args, kwargs, weight=0)
...
class ConsumerContentInstallScheduleManager(ConsumerScheduleManager):
    ...
    def create_unit_install_schedule(self, consumer_id, units, install_options, schedule_data ):
        ...
        @return: schedule id
        """
        return self._create_schedule(consumer_content_install_itinerary, consumer_id, units, install_options, schedule_data)
...
class ConsumerContentUpdateScheduleManager(ConsumerScheduleManager):
    ...
    def create_unit_update_schedule(self, consumer_id, units, update_options, schedule_data):
        ...
        @return: schedule id
        """
        return self._create_schedule(consumer_content_update_itinerary, consumer_id, units, update_options, schedule_data)
...
class ConsumerContentUninstallScheduleManager(ConsumerScheduleManager):
    ...
    def create_unit_uninstall_schedule(self, consumer_id, units, uninstall_options, schedule_data):
        ...
        @return: schedule id
        """
        return self._create_schedule(consumer_content_uninstall_itinerary, consumer_id, units, uninstall_options, schedule_data)

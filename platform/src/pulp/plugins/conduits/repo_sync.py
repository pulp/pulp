...
from   pulp.plugins.conduits.mixins import ImporterConduitException, AddUnitMixin, RepoScratchPadMixin, ImporterScratchPadMixin, GetRepoUnitsMixin, StatusMixin
...
class RepoSyncConduit(RepoScratchPadMixin, ImporterScratchPadMixin, AddUnitMixin, GetRepoUnitsMixin, StatusMixin):
    """

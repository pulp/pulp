...
class ReservedResource(Model):
    ...
    Fields:
        ...
        resource (~django.db.models.TextField): The name of the resource reserved for the task.

    Relations:

        task (~django.db.models.ForeignKey): The task associated with this reservation
        worker (~django.db.models.ForeignKey): The worker associated with this reservation
    """
...
class Worker(Model):
    ...
    Fields:
        ...
        name (~django.db.models.TextField): The name of the worker, in the format "worker_type@hostname"
        last_heartbeat (~django.db.models.DateTimeField): A timestamp of this worker's last heartbeat
        online (~django.db.models.BooleanField): Whether is the worker online or not. Default is True.
    """
...
class TaskLock(Model):
    ...
    Fields:
        ...
        name (~django.db.models.TextField): The name of the item that has the lock
        timestamp (~django.db.models.DateTimeField): The time the lock was acquired
        lock (~django.db.models.TextField): The name of the lock acquired
...
class Task(Model):
    ...
    Fields:
        ...
        group (~django.db.models.UUIDField): The group this task belongs to
        state (~django.db.models.TextField): The state of the task
        started_at (~django.db.models.DateTimeField): The time the task started executing
        finished_at (~django.db.models.DateTimeField): The time the task finished executing
    ...
    Relations:
        ...
        parent (~django.db.models.ForeignKey): Task that spawned this task (if any)
        worker (~django.db.models.ForeignKey): The worker that this task is in
    """
...
class TaskTag(Model):
    ...
    Fields:
        ...
        name (~django.db.models.TextField): The name of the tag

    Relations:

        task (~django.db.models.ForeignKey): The task this tag is associated with
    """

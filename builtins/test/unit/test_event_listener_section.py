...
from pulp_event import pulp_cli


class TestEventSection(unittest.TestCase):
    def test_subsection(self):
        context = mock.MagicMock()
        section = pulp_cli.EventSection(context)
        subsection = section.subsections.get('listener')

        self.assertTrue(isinstance(subsection, pulp_cli.ListenerSection))
...
class TestGenericSection(unittest.TestCase):
    ...
    def setUp(self):
        self.section = pulp_cli.GenericSection(mock.MagicMock(), 'section' ,'stuff')
...
class TestListenerSection(unittest.TestCase):
    def setUp(self):
        self.section = pulp_cli.ListenerSection(mock.MagicMock())
...
class TestEmailSection(unittest.TestCase):
    def setUp(self):
        self.section = pulp_cli.EmailSection(mock.MagicMock())
...
class TestRESTAPISection(unittest.TestCase):
    def setUp(self):
        self.section = pulp_cli.RestApiSection(mock.MagicMock())

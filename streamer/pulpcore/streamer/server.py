...
from pulpcore.plugins.loader import api as plugin_api
from pulpcore.server.constants import PULP_STREAM_REQUEST_HEADER
from pulpcore.server.content.sources.container import ContentContainer
from pulpcore.server.content.sources.model import Request as ContainerRequest
from pulpcore.server.db.model import DeferredDownload, LazyCatalogEntry
from pulpcore.server.controllers import repository as repo_controller
from pulpcore.plugins.loader.exceptions import PluginNotFound
from pulpcore.streamer import adapters as pulp_adapters
...
class Streamer(Resource):
    ...
    def _download(self, request, entry, responder):
        ...
        :type  entry: pulpcore.server.db.model.LazyCatalogEntry

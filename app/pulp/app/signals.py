...
from pulp.app.models import Artifact
from pulp.app.models.storage import FileSystem
...
def artifact_pre_delete(sender, instance, **kwargs):
    ...
    :type  sender: pulp.app.model.Artifact
    :param instance: The actual instance being deleted
    :type instance: pulp.app.model.Artifact instance
    """
    artifact = instance
